...
// Pre-configured credentials and API URL
const CLIENT_ID = "4704406777360.9749330797862";
const CLIENT_SECRET = "93bec9a02d53a3ed777d6ad9590edce3";
const PIRATE_API_URL = "https://pirate-monkeyness.com/api/translate";
...
// Root endpoint handles slash command directly
app.post("/", async (req, res) => {
    try {
        ...
        // Respond immediately to avoid dispatch_failed
        ...
        console.log("Posting pirate translation:", pirateText);
